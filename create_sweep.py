...
# To initialize W&B sweep config: $ uv run create_sweep.py <main.py> --name <sweep_name> --> prints <entity/project/sweep/sweep_id>
...
if __name__ == "__main__":
    ...
    parser.add_argument("program", type=str, help="Python training script to run")
